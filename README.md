# 🎉 ekphos - Effortless Markdown Research Tool

## 🚀 Getting Started

Welcome to ekphos! This is a lightweight, fast, terminal-based tool designed to help you with markdown research. Whether you are a student, a writer, or someone who likes to organize notes, ekphos makes the task easy and efficient.
...
Make sure your system meets the following requirements before installing ekphos:

- Operating System: Windows, macOS, or Linux
- Terminal: A terminal emulator that supports basic command line operations
...
2. **Extract the Files**:
   ...
   - If it's a zip file, right-click on it and select "Extract All" or use a file extraction tool of your choice.
...
4. **Navigate to the Folder**:
   - Use the `cd` command followed by the path to the ekphos folder. For example:
     ```
     cd path/to/ekphos
     ```

5. **Run ekphos**:
   - Enter the command to start ekphos:
     ```
     ./ekphos
     ```
...
ekphos offers a range of features designed to boost your productivity:

- **Markdown Editing**: Write in markdown format, preview your work in real-time.
- **Fast Performance**: Quick loading times for seamless usage.
- **Easy Navigation**: Simple command interface that simplifies your workflow.
- **Cross-Platform Support**: Use ekphos on your preferred operating system without hassle.
...
**Q: Is ekphos easy to use for beginners?**
